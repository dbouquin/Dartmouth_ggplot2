...
Data visualizations that would require dozens of lines of code on other platforms or with base R graphics, only require a few quick lines once we have installed `ggplot2`. You can use `install.packages()` to install packages from [CRAN][2] For example:
